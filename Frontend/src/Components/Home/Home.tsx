...
const Home = () => {
  return (
    <>
      <div className="w-full min-h-screem bg-white lg:px-16 md:px-24 sm:px-6 pr-1 pl-1 ">
        ...
        <div>
          <div className=" py-3 px-3 flex lg:flex-row flex-col gap-10  items-center">
            ...
            <div className=" lg:w-[500px] lg:h-[500px] md:w-[400px] md:h-[400px] sm:w-9/12 sm:h-[75vw] w-full h-[100vw]  rounded-2xl bg-cookie-bg2 bg-no-repeat bg-cover bg-center"></div>
          </div>
          <div className=" py-3 px-3 flex lg:flex-row-reverse flex-col gap-10  items-center">
            ...
            <div className=" lg:w-[500px] lg:h-[500px] md:w-[400px] md:h-[400px] sm:w-9/12 sm:h-[75vw] w-full h-[100vw]  rounded-2xl bg-cookie-bg3 bg-no-repeat bg-cover bg-center"></div>
          </div>
        </div>
      </div>
    </>
